...
const NeedVolunteers = () => {
  ...
  const cardLayout = allItems.length ? (
    <>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 container mx-auto gap-12 my-10 animate__animated animate__zoomIn animate__repeat-2 animate__slower	3s'>
