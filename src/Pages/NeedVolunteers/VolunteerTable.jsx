...
const VolunteerTable = ({ allItems }) => {
  ...
  return (
    <div className='container mx-auto w-1/2'>
      <table className=' divide-y divide-gray-200  lg:w-full'>
        <thead className='bg-[#d6eed7]'>
          <tr>
            <th
              scope='col'
              className='py-3.5 md:px-2 lg:px-6 text-xs md:text-sm font-normal text-left rtl:text-right text-gray-500'
            >
