                ...
                <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
                  ...
                  <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
                    <Link to='/need-volunteers'>
                      {" "}
                      <button className='w-full lg:px-5 py-2 tracking-wide transition-colors duration-200 shrink-0 sm:w-auto dark:hover:bg-blue-500 dark:bg-blue-600 btn bg-[#6faf9f] text-white lg:py-2 text-sm rounded-xl lg:ml-2 hover:bg-[#727C82] border-2 border-[#f77d5c]'>
                        Volunteer Positions
                      </button>
                    </Link>
